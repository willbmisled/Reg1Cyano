...
```{r getLakes, include=FALSE, echo=FALSE, cache=FALSE} 
library(rgdal)
library(maptools)
  MDB<-"c:/Users/FrayJorge/My Documents/EPA/Data/WaterbodyDatabase/WaterbodyDatabase.mdb" #data source
  #MDB<-"~/EPA/Data/WaterbodyDatabase/WaterbodyDatabase.mdb" #data source
...
#create KML file of location          
  kmlPoints(Loc, 
            ...
            name=paste("Location",Loc@data$LocID), 
...
* rename SpatialPointsDataFrame Loc to Locations 
...
a<-merge(Data2014,Locations@data[,c("LocID","WBID","Distance")],by='LocID',all.x=FALSE)
