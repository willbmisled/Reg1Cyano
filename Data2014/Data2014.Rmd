...
* Latest version of data received from Linda Bacon on 3/26/15 as "Cyanotoxin.zip"
* Data extracted and access database "Cyanotoxin.accdb" renamed "MEDEP.accdb"
* Earlier version of data received on 3/13/15 and 3/19/15
...
* Rep added as the rank of FluoroResultID by SampleID and Anal
* Data reformatted
...
FROM (Event LEFT JOIN Sample ON Event.EventID = Sample.eventid) LEFT JOIN FluoroResults ON Sample.SampleID = FluoroResults.SampleID;
    ...
    str(ME)
  #add rep field
    ME<-transform(ME,rep=ave(FluoroResultID,SampleID,Anal,FUN=function(x) rank(x,ties.method="first")))
