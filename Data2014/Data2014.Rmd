  ...
  #continue with template
    ...
    #change field Flag from Y/N to TRUE/FALSE
      table(UNH$Flag,useNA='ifany')
        #What are Flag=''
          UNH[UNH$Flag=='',c('SampleLocation','Latitude')] #blanks,calibration, and approximate GPS locations
            #Change blanks and calibration Flags to FALSE
              UNH$Flag[UNH$Flag==''& UNH$SampleLocation=='Blank']<-FALSE
              UNH$Flag[UNH$Flag==''& UNH$SampleLocation=='Calibration']<-FALSE
            #remaining Flag='' observations mean the location is approximate.  Change to TRUE
              UNH$Flag[UNH$Flag=='']<-FALSE #replace empty cells with FALSE
        #convert field to logical
          UNH$Flag<-gsub("Yes",TRUE,UNH$Flag)
          UNH$Flag<-gsub("No",FALSE,UNH$Flag)
          UNH$Flag<-as.logical(UNH$Flag) #convert to logical
    #Flag=TRUE observations have missing or approximate locations.  Add comment
      UNH$Comment[UNH$Flag==TRUE]<-paste("Location Approximate or Missing;",UNH$Comment[UNH$Flag==TRUE])
