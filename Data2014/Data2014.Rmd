...
The collated dataset is available here in .csv format: https://github.com/willbmisled/Reg1Cyano/blob/master/Data2014/Data2014.csv?raw=true
...
Field  | Units | Third
------------- | ------------- | -------------
**Order:**|(integer)|Leave Blank or number observation consecutively
...
#Build NHDES
  #Build Template first
    ...
    NH_T$WaterbodyName<-Loc$Waterbody
    NH_T$State<-'NH'
